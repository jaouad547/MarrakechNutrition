            ...
            <div className="max-w-6xl mx-auto py-8">
                <div className="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p className="text-gray-600">Gérez les catégories produits et leurs descriptifs.</p>
                    </div>
                    <Link
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700">Produits actifs</th>

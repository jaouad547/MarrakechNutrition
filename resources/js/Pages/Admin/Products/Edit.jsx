                ...
                <form onSubmit={submit} className="space-y-6 bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div>
                        ...
                        {product.image ? (
                            ...
                            <div className="mt-2 rounded-md border border-dashed border-gray-300 px-3 py-8 text-sm text-gray-500">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700">Remplacer l'image</label>
                        <input
                            type="file"
                            accept="image/*"

    ...
    return (
        <Layout>
            ...
            <div className="max-w-3xl mx-auto mt-10 bg-white p-8 rounded-lg shadow-md">
                <h2 className="text-2xl font-bold text-gray-800 mb-6">Informations du compte</h2>
                <form onSubmit={submit} className="space-y-4">
                    ...
                    <div className="pt-4">
                        <button type="submit" disabled={processing} className="px-4 py-2 bg-green-600 text-white rounded">Sauvegarder</button>
                    </div>
                </form>
                ...
                <form onSubmit={submitPassword} className="space-y-4">
                    ...
                    <div className="pt-4">
                        <button type="submit" disabled={pwdProcessing} className="px-4 py-2 bg-green-600 text-white rounded">Changer le mot de passe</button>
                    </div>
                </form>
            </div>
        </Layout>

...
export default function Index({ items, subtotal, deliveryFee, total, user }) {
    ...
    return (
        <Layout>
            <Head title={t('Validation de la commande')} />

            <div className="max-w-6xl mx-auto py-8 px-4">
                <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900">{t('Validation de la commande')}</h1>
                        <p className="text-gray-600">{t('Vérifiez vos informations de livraison et le récapitulatif de commande.')}</p>
                    </div>

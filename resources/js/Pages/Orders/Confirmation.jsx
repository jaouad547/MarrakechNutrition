        ...
        <Layout>
            ...
            <div className="max-w-5xl mx-auto py-8 px-4">
                <div className="rounded-xl bg-white p-8 shadow-sm">
                    ...
                    <p className="mt-2 text-gray-600">Merci pour votre commande !</p>
                    ...
                    <div className="mt-8 grid gap-6 lg:grid-cols-[2fr_1fr]">
                        <div className="space-y-6">
                            <section className="rounded-xl border border-gray-200 bg-gray-50 p-6">
                                ...
                                <p className="mt-4 text-gray-700"><span className="font-semibold">Nom :</span> {order.customer_name}</p>
                                <p className="mt-2 text-gray-700"><span className="font-semibold">Téléphone :</span> {order.phone}</p>
                                <p className="mt-2 text-gray-700"><span className="font-semibold">Adresse :</span> {order.delivery_address}</p>
                            </section>
                        ...
                        <aside className="space-y-6">
                            <section className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                                <h2 className="text-xl font-semibold text-gray-900">Résumé de paiement</h2>
                            ...
                            <section className="rounded-xl border border-gray-200 bg-gray-50 p-6">
                                <h2 className="text-xl font-semibold text-gray-900">Livraison</h2>
                                <p className="mt-4 text-gray-700">Votre commande sera livrée sous 2 à 4 jours ouvrés.</p>
                            </section>

                            <div className="space-y-3">
                                <Link href={route('home')} className="block rounded-md bg-green-600 px-4 py-3 text-center text-sm font-semibold text-white hover:bg-green-700">
                                    Retour à l’accueil
                                </Link>
                                {order.user_id && (
